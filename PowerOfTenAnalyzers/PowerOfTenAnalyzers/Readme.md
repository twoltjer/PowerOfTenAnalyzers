...
### PowerOfTenAnalyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [PowerOfTenAnalyzers.Sample.csproj](../PowerOfTenAnalyzers.Sample/PowerOfTenAnalyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### PowerOfTenAnalyzers.Tests
